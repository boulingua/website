...
entsprechenden Rechtsverletzungen werden diese Inhalte umgehend entfernt.
...
unterliegen dem deutschen Urheberrecht. Website-Code steht unter der
MIT-Lizenz, didaktische Inhalte stehen unter Creative Commons
Attribution-ShareAlike 4.0 (CC-BY-SA 4.0). Siehe `LICENSE` und
`LICENSE-content` im jeweiligen Repository für die vollständigen
Lizenzbedingungen.

Beiträge Dritter sind als solche gekennzeichnet. Die Vervielfältigung,
Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen
des Urheberrechts und der jeweils gewährten Lizenzen bedürfen der
schriftlichen Zustimmung des jeweiligen Autors beziehungsweise Erstellers.
